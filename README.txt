...
※重要※※重要※※重要※※重要※※重要※
注意）Geeklog2.1.3+reCAPTCHA1.1.5で動作確認しております。
      ※UIKit3.0利用のためGeeklogは2.1.3移行がオススメ
      ※reCAPTCHA1.1.5で動作確認していますのでそれと互換性があるバージョンで利用可能ですのでご注意ください。
※重要※※重要※※重要※※重要※※重要※
